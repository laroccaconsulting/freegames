...
- Quick arcade: **Snake** ✅ Built — `games/snake/` (Classic, Wrap, Zen; three speeds; swipe/keys/arrow pad; smooth drawing between ticks), a Breakout-style game, two-player Pong on one phone, SameGame, **Flood** ✅ Built — `games/flood/` (puzzle golf: beam-search par, daily, levels 8×8 → 18×18)
