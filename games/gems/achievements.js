// Gems achievements: plain data, also shown on the games list.
// id is the save key, so never change one. goal: a count to reach.
export default [
  { id: 'first', title: 'First clear', desc: 'Clear your first puzzle.' },
  ...
  { id: 'solved-50', title: 'Fifty', desc: 'Clear 50 puzzles.', goal: 50 },
