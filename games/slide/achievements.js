// Slide achievements: plain data, also shown on the games list.
// id is the save key, so never change one. goal: a count to reach.
export default [
  { id: 'first', title: 'First slide', desc: 'Solve your first puzzle.' },
  ...
  { id: 'tiles-5', title: 'Big tiles', desc: 'Solve a 5×5 tile puzzle.' },
];
