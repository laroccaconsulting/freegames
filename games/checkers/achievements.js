// Checkers achievements: plain data, also shown on the games list.
...
export default [
  ...
  { id: 'streak-3', title: 'Hat trick', desc: 'Beat the computer three games in a row.' },
  { id: 'flawless', title: 'Flawless', desc: 'Beat the computer without losing a piece.', secret: true },
];
